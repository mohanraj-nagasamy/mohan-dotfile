...
// Workspace Two
var ws2Snapshot_2Monitors_Name = 'ws2Snapshot_2Monitors_Name';
var take_ws2Snapshot_2Monitors = S.op('snapshot', {
    name: ws2Snapshot_2Monitors_Name,
    save: true
});

var activate_ws2Snapshot_2Monitors = S.op('activate-snapshot', {
    name: ws2Snapshot_2Monitors_Name
});
...
S.bnda({
  ...
  "2:fn,ctrl" : activate_ws2Snapshot_2Monitors,
  "2:fn,ctrl,alt,cmd" : take_ws2Snapshot_2Monitors,
...
S.log("[SLATE] -------------- Finished Loading Mohan's Config --------------");
